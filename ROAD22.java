...
public class ROAD22 extends Thread {
	private Semaphore slight2;
	private ArrayList<ArrayList<Semaphore>> semaphores;

	private int i, coordonnees[][];
	private String type;
	private String direction[] = { "ROAD21", "ROAD11", "ROAD12" };
	private String myDirection;

	public ROAD22(Semaphore slight2, ArrayList<ArrayList<Semaphore>> semaphores, int[][] coordonnees, String type) {
	...
	private void traversee2() throws InterruptedException {
		int x = 785, y = coordonnees[1][i], w = 40, h = 50;
		switch (type) {
		case "car":
			h = 50;
			break;
		case "bus":
	      ...
	      Icon icon = new ImageIcon("src/CARR.PNG");
		...
		semaphores.get(3).get(i).acquire();
